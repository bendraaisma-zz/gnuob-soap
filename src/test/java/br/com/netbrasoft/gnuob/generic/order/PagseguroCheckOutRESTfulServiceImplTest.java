...
public class PagseguroCheckOutRESTfulServiceImplTest {
  ...
  private ICheckOutWebService<Order> pagseguroCheckOutWebServiceImpl = new PagseguroCheckOutRESTfulServiceImpl();
  ...
  public void setUp() throws Exception {
    ...
    pagseguroCheckOutWebServiceImpl = new PagseguroCheckOutRESTfulServiceImpl(mockSecuredGenericTypeCheckOutService,
  ...
  public void testDoCheckoutDetailsOrderGettingGNUOpenBusinessServiceException() {
    pagseguroCheckOutWebServiceImpl = new PagseguroCheckOutWebServiceImpl<Order>();
