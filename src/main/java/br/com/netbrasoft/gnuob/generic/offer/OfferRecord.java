...
import static br.com.netbrasoft.gnuob.generic.NetbrasoftSoapConstants.GNUOB_OFFER_RECORDS_GNUOB_OPTIONS_TABLE_NAME;
import static br.com.netbrasoft.gnuob.generic.NetbrasoftSoapConstants.GNUOB_OFFER_RECORDS_ID_COLUMN_NAME;
...
import static br.com.netbrasoft.gnuob.generic.NetbrasoftSoapConstants.OFFER_RECORD_ENTITY_NAME;
import static br.com.netbrasoft.gnuob.generic.NetbrasoftSoapConstants.OFFER_RECORD_ID_COLUMN_NAME;
import static br.com.netbrasoft.gnuob.generic.NetbrasoftSoapConstants.OFFER_RECORD_TABLE_NAME;
...
public class OfferRecord extends AbstractType {
  ...
  public String getOfferRecordId() {
    if (isBlank(offerRecordId)) {
      offerRecordId = randomUUID().toString();
    }
