...
public enum OrderBy {
  ...
  PLACE_NAME_A_Z(Order.ASC, "placeName"),
  PLACE_NAME_Z_A(Order.DESC, "placeName"),
  COUNTRY_CODE_A_Z(Order.ASC, "countryCode"),
  COUNTRY_CODE_Z_A(Order.DESC, "countryCode"),
  POSTAL_CODE_A_Z(Order.ASC, "postalCode"),
  POSTAL_CODE_Z_A(Order.DESC, "postalCode"),
  STATE_NAME_A_Z(Order.ASC, "adminName1"),
  STATE_NAME_Z_A(Order.DESC, "adminName1"),
