...
public class PayPalExpressCheckOutServiceImpl<O extends Order> implements CheckOutService<O> {
    ...
    public void doCheckout(O order) {
        ...
        setExpressCheckoutRequestType.setVersion(System.getProperty(PAYPAL_VERSION_PROPERTY, PAYPAL_VERSION_PROPERTY_VALUE));
    ...
    public void doCheckoutDetails(O order) {
        ...
        getExpressCheckoutDetailsRequestType.setVersion(System.getProperty(PAYPAL_VERSION_PROPERTY, PAYPAL_VERSION_PROPERTY_VALUE));
    ...
    public void doCheckoutPayment(O order) {
        ...
        doExpressCheckoutPaymentRequestType.setVersion(System.getProperty(PAYPAL_VERSION_PROPERTY, PAYPAL_VERSION_PROPERTY_VALUE));
    ...
    private PaymentDetailsType doPaymentDetailsType(O order) {
        ...
        // transaction.
        paymentDetailsType.setNotifyURL(System.getProperty(GNUOB_SITE_PROPERTY, GNUOB_SITE_PROPERTY_VALUE));
    ...
    private SetExpressCheckoutRequestDetailsType doSetExpressCheckoutRequestsDetailsType(O order) {
        ...
        setExpressCheckoutRequestDetailsType.setReturnURL(System.getProperty(GNUOB_SITE_PROPERTY, GNUOB_SITE_PROPERTY_VALUE));

        // URL to which the buyer is returned if the buyer does not approve the
        // use of PayPal to pay you. For digital goods.
        setExpressCheckoutRequestDetailsType.setCancelURL(System.getProperty(GNUOB_SITE_PROPERTY, GNUOB_SITE_PROPERTY_VALUE));
        ...
        // Set brand name.
        setExpressCheckoutRequestDetailsType.setBrandName(System.getProperty(GNUOB_SITE_PROPERTY, GNUOB_SITE_PROPERTY_VALUE));
