...
public class ContractWebServiceImpl<C extends Contract> implements GenericTypeWebService<C> {
    ...
    public List<C> find(@WebParam(name = "metaData", header = true) MetaData metadata, @WebParam(name = "contract") C type, @WebParam(name = "paging") Paging paging, @WebParam(name = "orderBy") OrderBy orderBy) {
        try {
