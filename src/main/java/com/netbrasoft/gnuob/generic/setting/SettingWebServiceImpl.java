...
public class SettingWebServiceImpl<S extends Setting> implements GenericTypeWebService<S> {
	...
	public long count(@WebParam(name = "metaData", header = true) MetaData metadata, @WebParam(name = "Setting") S type) throws GNUOpenBusinessServiceException {
		try {
	...
	public S find(@WebParam(name = "metaData", header = true) MetaData metadata, @WebParam(name = "Setting") S type) throws GNUOpenBusinessServiceException {
		try {
	...
	public List<S> find(@WebParam(name = "metaData", header = true) MetaData metadata, @WebParam(name = "Setting") S type, @WebParam(name = "paging") Paging paging, @WebParam(name = "orderBy") OrderBy orderBy) throws GNUOpenBusinessServiceException {
		try {
	...
	public S merge(@WebParam(name = "metaData", header = true) MetaData metadata, @WebParam(name = "Setting") S type) throws GNUOpenBusinessServiceException {
		try {
	...
	public S persist(@WebParam(name = "metaData", header = true) MetaData metadata, @WebParam(name = "Setting") S type) throws GNUOpenBusinessServiceException {
		try {
	...
	public void remove(@WebParam(name = "metaData", header = true) MetaData metadata, @WebParam(name = "Setting") S type) throws GNUOpenBusinessServiceException {
		try {
